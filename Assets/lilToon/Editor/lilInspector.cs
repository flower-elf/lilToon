...
namespace lilToon
{
    ...
    public class lilToonInspector : ShaderGUI
    {
        ...
        {
            var t = new MaterialType(material, isMultiVariants);
            isLite          = t.isLite;
            isCutout        = t.isCutout;
            ...
            isTess          = t.isTess;
            isGem           = t.isGem;
            isFakeShadow    = t.isFakeShadow;
            isOnePass       = t.isOnePass;
            isTwoPass       = t.isTwoPass;
            isMulti         = t.isMulti;
            isCustomShader  = t.isCustomShader;
            isShowRenderMode = t.isShowRenderMode;
            isStWr = t.isStWr;
            renderingModeBuf = t.renderingModeBuf;
            transparentModeBuf = t.transparentModeBuf;
            isUseAlpha = t.isUseAlpha;
        }

        internal struct MaterialType
        {
            public RenderingMode renderingModeBuf;
            public TransparentMode transparentModeBuf;
            public bool isLite;
            ...
            internal MaterialType(Material material, bool isMultiVariants)
            {
                ...
                isStWr          = material.GetFloat("_StencilPass") == (float)StencilOp.Replace;
        ...
        private void TextureBakeGUI(Material material, int bakeType)
        {
            ...
            if(lilEditorGUI.Button(sBake[bakeType]))
            {
                ...
                lilMaterialBaker.TextureBake(material, bakeType);
            }
        }
